<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultarCanchas.aspx.cs" Inherits="ReservaCanchasF5.Pages.Canchas.ConsultarCanchas" %>
        ...
        <div class="container">
            <div class="price-table row-fluid">
                ...
                <div class="span10 price-column">
                    <ul class="list">
                        <li>
                            <div runat="server" visible="true" id="Div3" class="alert alert-info" role="alert">Mis Canchas</div>
